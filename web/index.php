...
<body class="theme-red">
  ...
  <div class="vg-page page-home" id="home" style="background-image: url(../html/assets/img/bg_image_1.jpg)">
    ...
    <div class="caption-header text-center wow zoomInDown">
      ...
      <h1 class="fw-light mb-4">I'm <b class="fg-theme">shivam</b> kumar</h1>
      <div class="badge">Web Designer</div>
    ...
    <div class="container py-5">
      <div class="row">
        ...
        <div class="col-lg-6 offset-lg-1 wow fadeInRight">
          <h1 class="fw-light">shivam kumar</h1>
          <h5 class="fg-theme mb-3">UI/UX & Web Designer</h5>
          <p class="text-muted">hello im shivam kumar i am a bsc CS i have good percentage </p>
          <ul class="theme-list">
            <li><b>From:</b> neyveli , tamilnadu</li>
            <li><b>Lives In:</b> neyveli , tamilnadu</li>
            <li><b>Age:</b> 20</li>
            <li><b>Gender:</b> Male</li>
          </ul>
          <a href="C:\Users\Hp\Desktop\intern\shivam personal information\virtual-folio\html\assets\img\Document (12) (1).pdf"><button class="btn btn-theme-outline">Download CV</button></a>
        </div>
      </div>
    </div>
    <div class="container py-5">
        ...
        <div class="col-md-6 wow fadeInRight">
          ...
          <ul class="timeline mt-4 pr-md-5">
            ...
            <li>
              ...
              <div class="details">
                <h5>HSC</h5>
                <small class="fg-theme">Jawahar matric higher secondary school</small>
                <p>mark percentage- 45.17%</p>
              </div>
            </li>
            <li>
              ...
              <div class="details">
                <h5></h5>
                <small class="fg-theme">jawahar higher secondary school</small>
                <p>mark percentage-70%</p>
              </div>
            </li>
          </ul>
        </div>
  ...
  <div class="vg-page page-contact" id="contact">
    <div class="container-fluid">
      ...
      <div class="row py-5">
        ...
        <div class="col-lg-5">
          <form name="frmContact" method="post" action="shivam.php">
						<p>
      ...
      <div class="row">
        <div class="col-lg-4 py-3">
          <div class="footer-info">
            ...
            <hr class="divider">
            <p class="fs-large fg-white">21-b type-2 block-6 neyveli tamilnadu</p>
          </div>
        </div>
        <div class="col-md-6 col-lg-3 py-3">
          <div class="float-lg-right">
            ...
            <ul class="list-unstyled">
              <li>shivam290420019@gmail.com</li>
              <li>+91 9500436238</li>
        ...
        <div class="col-md-6 col-lg-3 py-3">
          <div class="float-lg-right">
            ...
            <hr class="divider">
            <ul class="list-unstyled">
              <li><a href="https://instagram.com/_me_lucky__?utm_medium=copy_link">Instagram</a></li>
              <li><a href="https://www.facebook.com/praveekutty.718">Facebook</a></li>
              <li><a href="https://twitter.com/shivampv22?t=0yRETzqva80sYFn-QOLOJA&s=09">Twitter</a></li>
            </ul>
          </div>
        </div>
      </div>
